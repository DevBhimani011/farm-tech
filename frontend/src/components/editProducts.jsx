...
const EditProducts = () => {
  ...
  const fetchProducts = async () => {
    try {
      const response = await axios.get(import.meta.env.VITE_BACKEND_URL+'/item/all-products');
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.put(`${import.meta.env.VITE_BACKEND_URL}/item/edit/${selectedProduct._id}`, editForm);
      setOpenDialog(false);
      fetchProducts();
